...
scripts/
  ...
  render_rollout.py, render_phase5_gifs.py, render_phase6_transfer.py   regenerate media
...
wildfire_phase3_multiseed/     main results: per-episode CSV, summary, LaTeX table, curves,
                               logs, MANIFEST.sha256, FREEZE.json + seed-42 checkpoints
wildfire_phase3_hiercomm_learned/  learned-commander ablation (same shape)
wildfire_phase4/               ablations
wildfire_phase4_extended/      extended difficulty sweep (supersedes phase4's sweep)
wildfire_phase6/               transfer + generalization
...
|---|---|
| Main results table (WEL / ISR, 7 policies × 2 regions) | `wildfire_phase3_multiseed/phase3_summary.json` |
| Per-episode records behind every mean | `wildfire_phase3_multiseed/phase3_raw.csv` |
| Significance tests | recomputed by `scripts/verify_supplement.py` |
| Learned-commander ablation | `wildfire_phase3_hiercomm_learned/phase3_summary.json` |
| Ablations | `wildfire_phase4/ablation_summary.json` |
| Difficulty sweep | `wildfire_phase4_extended/robustness_results.csv` |
| Transfer matrix, TRS, asymmetry | `wildfire_phase6/transfer_summary.json` |
