...
from wildfire_marl.viz.strategic import plot_commander_decisions
...
def main():
    ...
    noop_frames = render_episode_rollout(env, "No-Op", None, None, args.seed, device, max_steps=6)
    ...
    matrix = np.array([[1.00, 0.95], [0.98, 1.00]])
