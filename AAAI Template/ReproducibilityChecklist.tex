...
\begin{itemize}
	...
	no [TODO(phase-6): add a data-provenance appendix documenting the GIS-derived landscape construction]
	...
	partial [TODO(phase-6): finalize the public release plan (hashed data bundle, research license)]
	...
	partial [TODO(phase-6): add citations for the ERA5 weather and MODIS NDVI sources in Section 5]
...
\begin{itemize}
	...
	no [TODO(phase-8): document hyperparameter ranges tried and the selection criterion, or state that library defaults were used]

	\question{Any code required for pre-processing data is included in the appendix}{(yes/partial/no)}
	partial [TODO(phase-6): package the data-to-simulator preprocessing pipeline in the supplementary code appendix]
	...
	partial [TODO(phase-6): assemble the complete supplementary code package (training, evaluation, analysis)]
	...
	partial [TODO(phase-6): add paper cross-references in code comments for the commander training pipeline]
	...
	partial [TODO(phase-6): disclose the evaluation seed values and seeding utility in the appendix]
	...
	no [TODO(phase-6): add a compute-disclosure appendix (hardware, OS, memory, library versions, wall-clock)]
	...
	partial [TODO(phase-6): align Table 4 with the released checkpoint configurations (audit issue C8)]
